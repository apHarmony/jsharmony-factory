...
jsh.AppSrv.ExecRow(req._DBContext, "select codemean,codecodemean,codeattribmean from GCOD2_H where codename=@codename", [dbtypes.VarChar(16)], { 'codename': codename }, function (err, rslt) {
