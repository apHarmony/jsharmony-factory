...
insert into {schema}_code2_doc_scope_doc_ctgr(code_val1, code_va12, code_txt) values ('sys_user','DOCUMENT','DOCUMENT');
insert into {schema}_code2_doc_scope_doc_ctgr(code_val1, code_va12, code_txt) values ('sys_user','IMAGE','IMAGE');
insert into {schema}_code2_doc_scope_doc_ctgr(code_val1, code_va12, code_txt) values ('sys_user','OTHER','OTHER');
