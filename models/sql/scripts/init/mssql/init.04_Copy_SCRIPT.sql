...
(
 ...
 CONSTRAINT [UNQ_GCOD_%%%name%%%_{code_txt}] UNIQUE NONCLUSTERED 
(
	[{code_txt}] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [UNQ_GCOD_%%%name%%%_{code_val}] UNIQUE NONCLUSTERED 
(
	[{code_val}] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
BEGIN
  ...
  DECLARE @D_{code_val} NVARCHAR(MAX)
  DECLARE @I_{code_val} NVARCHAR(MAX)
  ...
  BEGIN
	...
	BEGIN  
	  ...
	  EXEC	@MY_{audit_seq} = {schema}.{log_audit_base} @TP, ''''GCOD_%%%name%%%'''', @WK_GCOD_ID, @MYUSER, @CURDTTM
	END
...
UPDATE [jsharmony].[SCRIPT] SET [{script_txt}].WRITE(N'{code_seq}) > 0)
      ...
      IF (@TP = ''D'' AND @D_{code_val} IS NOT NULL OR
          @TP = ''U'' AND {schema}.{nequal_chr}(@D_{code_val}, @I_{code_val}) > 0)
      BEGIN
        IF (@MY_{audit_seq}=0)
		  EXEC	@MY_{audit_seq} = {schema}.{log_audit_base} ''U'', ''GCOD_%%%name%%%'', @I_GCOD_ID, @MYUSER, @CURDTTM
        INSERT INTO {schema}.{audit_detail} VALUES (@MY_{audit_seq}, lower(''{code_val}''), @D_{code_val})
      END
...
(
 ...
 CONSTRAINT [UNQ_GCOD2_%%%name%%%_{code_val1}_{code_va12}] UNIQUE NONCLUSTERED 
(
	[{code_val1}] ASC,
	[{code_va12}] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [UNQ_GCOD2_%%%name%%%_{code_val1}_{code_txt}] UNIQUE NONCLUSTERED 
(
	[{code_val1}] ASC,
	[{code_txt}] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
	...
	BEGIN
      UPDATE %%%schema%%%.GCOD2_%%%name%%%
	     SET {code_etstmp} = @CURDTTM,
		     ...
		     {code_mtstmp} = @CURDTTM,
			 {code_muser} = @MYUSER
       WHERE GCOD2_%%%name%%%.{code2_app_id} = @I_{code2_app_id};
    END  
...
'+N'UPDATE [jsharmony].[SCRIPT] SET [{script_txt}].WRITE(N''************************/
	...
	BEGIN  
	  ...
	  EXEC	@MY_{audit_seq} = {schema}.{log_audit_base} @TP, ''''GCOD2_%%%name%%%'''', @WK_{code2_app_id}, @MYUSER, @CURDTTM
	END
	...
	BEGIN
      ...
      BEGIN
        IF (@MY_{audit_seq}=0)
		  EXEC	@MY_{audit_seq} = {schema}.{log_audit_base} ''''U'''', ''''GCOD2_%%%name%%%'''', @I_{code2_app_id}, @MYUSER, @CURDTTM
        INSERT INTO {schema}.{audit_detail} VALUES (@MY_{audit_seq}, lower(''''{code_seq}''''), @D_{code_seq})
      END
...
(
 ...
 CONSTRAINT [UNQ_UCOD_%%%name%%%_{code_txt}] UNIQUE NONCLUSTERED 
(
	[{code_txt}] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [UNQ_UCOD_%%%name%%%_{code_val}] UNIQUE NONCLUSTERED 
(
	[{code_val}] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
(
 ...
 CONSTRAINT [UNQ_UCOD2_%%%name%%%_{code_val1}_{code_va12}] UNIQUE NONCLUSTERED 
(
	[{code_val1}] ASC,
	[{code_va12}] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [UNQ_UCOD2_%%%name%%%_{code_val1}_{code_txt}] UNIQUE NONCLUSTERED 
(
	[{code_val1}] ASC,
	[{code_txt}] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
