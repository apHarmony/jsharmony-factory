...
--
-- Name: version__tbl_iud(); Type: FUNCTION; Schema: {schema}; Owner: postgres
--
...
--
-- Name: version__tbl_iud; Type: TRIGGER; Schema: {schema}; Owner: postgres
--
...
--
-- Name: version__tbl_iud(); Type: ACL; Schema: {schema}; Owner: postgres
--
