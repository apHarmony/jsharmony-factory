...
jsh.AppSrv.ExecRow(req._DBContext, "select codemean,codecodemean,codeattribmean from jsharmony.ucod2_h where codename=@codename and coalesce(codeschema,'')=coalesce(@codeschema,'')", [dbtypes.VarChar(128),dbtypes.VarChar(128)], { 'codename': codename, 'codeschema': codeschema }, function (err, rslt) {
