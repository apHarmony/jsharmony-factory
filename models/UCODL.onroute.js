...
jsh.AppSrv.ExecRow(req._DBContext, "select codemean,codecodemean,codeattribmean from jsharmony.ucod_h where codename=@codename and coalesce(codeschema,'')=coalesce(@codeschema,'')", [dbtypes.VarChar(16),dbtypes.VarChar(16)], { 'codename': codename, 'codeschema': codeschema }, function (err, rslt) {
