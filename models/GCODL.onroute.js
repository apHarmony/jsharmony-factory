...
jsh.AppSrv.ExecRow(req._DBContext, "select codemean,codecodemean,codeattribmean from jsharmony.GCOD_H where codename=@codename and codeschema=@codeschema", [dbtypes.VarChar(16),dbtypes.VarChar(16)], { 'codename': codename, 'codeschema': codeschema }, function (err, rslt) {
