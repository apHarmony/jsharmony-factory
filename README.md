...
2. Create a file the project root named "app.js" with the following code:
...
** It is recommended to use the node-supervisor program to auto-refresh the server on updates:
